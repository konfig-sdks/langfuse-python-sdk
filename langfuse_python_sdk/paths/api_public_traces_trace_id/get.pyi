...
from langfuse_python_sdk.model.trace import Trace as TraceSchema

from langfuse_python_sdk.type.trace import Trace

from ...api_client import Dictionary
from langfuse_python_sdk.pydantic.trace import Trace as TracePydantic

# Path params
TraceIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'traceId': typing.Union[TraceIdSchema, str, ],
    }
)
...
request_path_trace_id = api_client.PathParameter(
    name="traceId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TraceIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = TraceSchema
    ...
    async def _aget_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/public/traces/{traceId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        **kwargs,
        ...
        if validate:
            return TracePydantic(**raw_response.body)
        return api_client.construct_model_instance(TracePydantic, raw_response.body)
