...
from langfuse_python_sdk.model.observation import Observation as ObservationSchema

from langfuse_python_sdk.type.observation import Observation

from ...api_client import Dictionary
from langfuse_python_sdk.pydantic.observation import Observation as ObservationPydantic

# Path params
ObservationIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'observationId': typing.Union[ObservationIdSchema, str, ],
    }
)
...
request_path_observation_id = api_client.PathParameter(
    name="observationId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ObservationIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = ObservationSchema
    ...
    async def _aget_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/public/observations/{observationId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        **kwargs,
        ...
        if validate:
            return ObservationPydantic(**raw_response.body)
        return api_client.construct_model_instance(ObservationPydantic, raw_response.body)
