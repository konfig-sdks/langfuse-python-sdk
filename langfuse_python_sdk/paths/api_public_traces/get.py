...
from langfuse_python_sdk.model.traces import Traces as TracesSchema

from langfuse_python_sdk.type.traces import Traces

from ...api_client import Dictionary
from langfuse_python_sdk.pydantic.traces import Traces as TracesPydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'orderBy': typing.Union[OrderBySchema, None, str, ],
...
SchemaFor200ResponseBodyApplicationJson = TracesSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        order_by: typing.Optional[typing.Optional[str]] = None,
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/public/traces',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return TracesPydantic(**raw_response.body)
        return api_client.construct_model_instance(TracesPydantic, raw_response.body)
