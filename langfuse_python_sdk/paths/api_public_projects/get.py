...
from langfuse_python_sdk.model.projects import Projects as ProjectsSchema

from langfuse_python_sdk.type.projects import Projects

from ...api_client import Dictionary
from langfuse_python_sdk.pydantic.projects import Projects as ProjectsPydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectsSchema
    ...
    async def _aget_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/public/projects',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        **kwargs,
        ...
        if validate:
            return ProjectsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsPydantic, raw_response.body)
