...
# Path params
ScoreIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'scoreId': typing.Union[ScoreIdSchema, str, ],
    }
)
...
request_path_score_id = api_client.PathParameter(
    name="scoreId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ScoreIdSchema,
    required=True,
)
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/public/scores/{scoreId}',
            auth_settings=_auth,
            headers=_headers,
        )
