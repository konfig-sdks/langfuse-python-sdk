...
class RequiredHealthResponse(TypedDict):
    # Langfuse server version
    version: str

    status: str

class OptionalHealthResponse(TypedDict, total=False):
    pass

class HealthResponse(RequiredHealthResponse, OptionalHealthResponse):
    pass
