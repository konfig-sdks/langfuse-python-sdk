...
class RequiredCreateScoreRequest(TypedDict):
    traceId: str
...
class OptionalCreateScoreRequest(TypedDict, total=False):
...
class CreateScoreRequest(RequiredCreateScoreRequest, OptionalCreateScoreRequest):
    pass
