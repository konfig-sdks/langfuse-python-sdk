...
from langfuse_python_sdk.paths.api_public_prompts import post
from langfuse_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiPublicPrompts(ApiTestMixin, unittest.TestCase):
    """
    ApiPublicPrompts unit test stubs
    """
